...
- **Force Max Quality:** Attempts to automatically force the highest available video playback quality.
- **Picture-in-Picture:** Injects a native PiP button into the YouTube player controls for easy multitasking.

## Settings

The extension includes a popup menu where you can toggle all features on or off in real-time.
